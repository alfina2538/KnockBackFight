...
type CountTitle = typeof CountTitle[keyof typeof CountTitle];
...
type CountDuration = typeof CountDuration[keyof typeof CountDuration];
...
export class Count {
  ...
  /**
    ...
    */
  private CountDown(title: CountTitle, duration: CountDuration) {
    system.runTimeout(() => {
      Playeres.players.forEach(p => {
  ...
  /**
    ...
    */
  private ShowStart(title: CountTitle, duration: CountDuration) {
    system.runTimeout(() => {
      Playeres.players.forEach(p => {
